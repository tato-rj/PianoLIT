<div class="tab-pane fade" id="tab-score">
	...
	<div class="non-ios" style="display: none;">
		<div class="text-center mb-4">
			...
			<a href="{{storage($piece->score_path)}}" target="_blank" class="btn btn-wide rounded-pill btn-default">@fa(['icon' => 'file-alt'])Download score</a>
		</div>
	</div>
		...
		<div class="embed-responsive embed-responsive-a4 mb-4 position-relative">
			...
			<div class="w-100 h-100 position-absolute d-flex flex-center" style="top: 0; left: 0; background-color: rgba(255,255,255,0.6)">
				<div class="d-flex flex-column">
					<a href="{{storage($piece->score_path)}}" target="_blank" class="btn rounded-pill btn-wide btn-default shadow-center mb-2">@fa(['icon' => 'file-alt'])Download score</a>
