<div style="display: none" id="upload-overlay" class="screen-lock-overlay">
    <div class="h-100 text-white d-flex text-center justify-content-center align-items-center">
        <div class="px-4">
            <div class="progress mb-3 animated shadow rounded-pill" style="height: 25px">
                <div class="progress-bar progress-bar-stripedx rounded-pill progress-bar-animated font-weight-bold" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 0%; height: 100%"></div>
            </div>
