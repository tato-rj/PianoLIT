	...
	<div class="custom-scroll dragscroll dragscroll-horizontal">
		<div class="d-flex pb-2" style="height: 144px;">
			@foreach($row['content'] as $card)
				<div class="mr-3 cursor-pointer rounded h-100 d-flex align-items-end p-3 gallery-card position-relative" style="background: linear-gradient(to right, {{gradient($card->color)[0]}}, {{gradient($card->color)[1]}});">
