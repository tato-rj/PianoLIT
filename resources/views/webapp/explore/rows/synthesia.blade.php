...
@component('webapp.components.grids.grid')
	@foreach($row['collection'] as $tutorial)
		<div class="m-2 position-relative">
			...
			@endauth
			<div class="border cursor-pointer rounded d-flex d-apart flex-column p-3 piece-card" role="img" aria-label="{{$tutorial->piece->name}}" data-url="{{route('webapp.pieces.show', $tutorial->piece)}}#tutorial">
