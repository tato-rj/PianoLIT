<div class="border py-4 px-3 h-100">
    <div class="ml-2 mb-4">
        ...
        <p class="text-muted">There {{str_plural('is', $upcomingDeathdays->count())}} {{$upcomingDeathdays->count()}} {{str_plural('deathday', $upcomingDeathdays->count())}} over the next 10 days.</p>
    </div>
    <div class="mx-2">
