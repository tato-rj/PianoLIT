		...
		<div class="show-on-hover">
		    <div class="m-0 absolute-center z-10 text-center">
		        <a class="link-none" href="">
		        	<div class="cursor-pointer text-warning clip mb-4" data-clipboard-text="/storage/{{$file}}" data-toggle="tooltip" title="Copied!" data-trigger="manual"><strong>copy</strong></div>
		        </a>
