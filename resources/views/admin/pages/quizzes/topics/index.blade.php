...
<div class="content-wrapper">
  ...
  @include('admin.components.breadcrumb', [
    'title' => 'Quiz topics',
    'description' => 'Manage the quiz topics'])
    
    <div class="row mb-3">
      <div class="col-12">
        <form method="POST" action="{{route('admin.quizzes.topics.store')}}" class="form-inline">
          @csrf
    ...
    <div class="row my-3">
      ...
      <div class="col-12">
        <div class="d-flex flex-wrap mb-2">
          @each('admin.pages.quizzes.topics.topic', $topics, 'topic')
        </div>
      </div>
    </div>
