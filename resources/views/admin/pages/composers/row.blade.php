<tr>
  ...
  <td class="text-right" style="white-space: nowrap;">
      <a href="{{route('email-preview.birthday', ['composer_id' => $composer->id])}}" target="_blank" title="See a preview of the birthday email" class="text-muted mr-2"><i class="fas fa-birthday-cake"></i></a>
      @can('update', $composer)
