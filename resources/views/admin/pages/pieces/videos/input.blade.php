<div class="form-group type-container {{$type ?? ''}} mb-2 videos-form" style="display: {{$display ?? null}}">
	<div class="btn btn-sm btn-outline-secondary mb-1 cursor-pointer default-performance" style="display: none;" data-title="Performance" data-description="Watch a video recording of this piece">Default performance</div>
