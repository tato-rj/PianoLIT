...
<form method="POST" action="{{route('admin.metaverse.store')}}">
  @csrf
  @select(['bag' => 'default', 'name' => 'location_id', 'placeholder' => 'Location', 'options' => (new \App\Metaverse\MetaverseEvent)->locations()])

  @input(['bag' => 'default', 'name' => 'theme', 'placeholder' => 'Theme', 'limit' => 255])

  @textarea(['bag' => 'default', 'name' => 'description', 'placeholder' => 'Description (optional)', 'rows' => 4, 'required' => false])

  <div class="form-row"> 
    @select(['bag' => 'default', 'name' => 'time', 'placeholder' => 'Time', 'options' => timeslots()->toArray(), 'grid' => 'col'])
    @select(['bag' => 'default', 'name' => 'duration', 'placeholder' => 'Duration', 'options' => (new \App\Metaverse\MetaverseEvent)->durations(), 'grid' => 'col'])
  </div>
