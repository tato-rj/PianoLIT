    ...
    <form id="update-ebook" class="row my-3" method="POST" action="{{route('admin.escores.update', $escore)}}" autocomplete="off" enctype="multipart/form-data">
      ...
      <div class="col">
        ...
        <div class="form-group">
          <div class="input-group">
            <div class="input-group-prepend">
              <a class="input-group-text no-underline {{$escore->shelf_cover_path ? 'text-success' : 'text-muted opacity-4'}}" href="{{storage($escore->shelf_cover_path)}}" target="_blank">@fa(['icon' => 'file-image', 'mr' => 0])</a>
            </div>
            <div class="custom-file">
