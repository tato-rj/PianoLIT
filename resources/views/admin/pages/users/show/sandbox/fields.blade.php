...
@else
	<input type="hidden" name="latest_expired_receipt" value="{{$user->subscription->latest_receipt}}">
	<input type="hidden" name="latest_expired_receipt_info" value="{{json_encode($user->subscription->latest_receipt_info)}}">
@endif
