	...
	<div class="row position-relative mb-4" id="options-container" style="display: none;">
		...
		<div class="col-12">
			<div class="rounded bg-light px-5 py-4 text-center">
				<p class="text-muted m-0">Some notes on the piano can have more than one name (we call these <u>enharmonics</u>). You can help us narrow down your results by specifying which notes you mean from these enharmonics. If this is relevant, just select from each group below.</p>
