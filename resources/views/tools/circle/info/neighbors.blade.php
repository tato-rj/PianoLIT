@component('components.overlays.modal', ['title' => 'Neighbor Keys', 'size' => 'lg'])
	...
	<p>If a piece modulates (changes keys), chances are it will move to one of its neighbors. This is because you just need to <u>change one note to move into the new key</u>, making it easier and seamless. It is not at all uncommon to modualte to more distant keys, of course, but it is more difficult to do that. Composers will often move gradually, going from one neighbor key to the next, until they reach the distant new key.</p>
