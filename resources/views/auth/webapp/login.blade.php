@component('auth.webapp.layout', ['title' => 'Log in to PianoLIT', 'subtitle' => 'If you already have a profile on our iOS app, you can use the same email and password to log in from here.'])
