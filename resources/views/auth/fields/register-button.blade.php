...
<button disable-on-submit data-sitekey="{{config('services.recaptcha.key')}}" data-callback='onSubmit' type="submit" class="g-recaptcha btn btn-primary shadow btn-block mb-2">Register</button>
<div class="mb-4">
