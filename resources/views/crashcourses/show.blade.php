...
<div class="container-fluid p-4">
  <div class="position-relative d-flex d-apart flex-column" style="min-height: 100vh; background-color: rgba(222,237,249,0.8)">
    ...
    <div class="text-center" style="padding-top: 90px; padding-bottom: 32px; margin-bottom: 80px">
    ...
    <div class="mx-auto position-relative" style="max-width: 75%; padding: 0 182px; overflow-y: hidden;">
