<div id="{{$name}}-overlay" class="position-fixed w-100 h-100vh z-40" style="top: 0; left: 0; display: none; overflow-y: auto">
	...
	<div data-target="#{{$name}}-overlay" class="close-overlay d-flex justify-content-center align-items-{{$position}} w-100 h-100" style="background: rgba(255,255,255,{{$opacity ?? 0.94}});">
