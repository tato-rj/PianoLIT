@component('layouts.overlay', ['name' => 'search', 'light' => true, 'background' => '255,255,255,1', 'window_bg' => 'white', 'position' => 'top'])
<div class="container py-5">
	<div class="row">
		<div class="col-lg-10 col-12 mx-auto">
			<input autocomplete="off" type="text" name="search" class="border-bottom p-4 text-lead rounded-0 bg-transparent border-grey w-100 mb-4" 
