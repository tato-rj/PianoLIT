	...
	<div id="screens-composition" class="row">
		...
		<div class="col-12 text-center">
			<div id="screens-container" class="position-relative text-center mx-auto" style="height: 592px;">
				...
				<img src="{{asset('images/mockup/composition/videos.jpg')}}" class="absolute-center rounded shadow-light" style="height: 62%; z-index: 2; transition: .2s">
				<img src="{{asset('images/mockup/composition/tags.jpg')}}" class="absolute-center rounded shadow-light" style="height: 62%; z-index: 2; transition: .2s">
				<img src="{{asset('images/mockup/composition/user.jpg')}}" class="absolute-center rounded shadow-light" style="height: 48%; z-index: 1; transition: .3s">
				<img src="{{asset('images/mockup/composition/matches.jpg')}}" class="absolute-center rounded shadow-light" style="height: 48%; z-index: 1; transition: .3s">				
			</div>
		</div>
	</div>
</section>