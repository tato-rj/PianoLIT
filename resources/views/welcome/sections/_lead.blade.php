<section class="container mb-5">
	<div class="row">
		<div class="col-lg-9 col-sm-10 col-12 mx-auto text-center">
			...
			<a href="#"><img src="{{asset('images/apple/coming_up.svg')}}" height="50" class="mb-2"></a>
		...
		<div class="col-12 text-center">
			...
			<div class="row mb-4">
				<div class="col-12">
					<p class="text-center mx-auto">In the mean time, subscribe to our <a href="https://www.youtube.com/channel/UCOB67MpdySxyTCZHvWgxHeg" target="_blank" class="link-blue">Youtube Channel</a> and enjoy daily videos of awesome piano pieces and tips!</p>
				</div>
