  ...
  <div class="text-center col-lg-8 col-md-10 col-12 mx-auto mb-6">
    ...
    @include('components.search.form', ['large' => true])
  	...
  	<div class="text-muted">
  		...
  		<div>Ex: <i><u class="search-suggestion cursor-pointer">pieces good for the left hand</u></i>, <i><u class="search-suggestion cursor-pointer">flashy intermediate repertoire</u></i>, <i><u class="search-suggestion cursor-pointer">4-hands for beginners</u></i>, etc...</div>
  	</div>
  </div>
</div>
<div class="row">
