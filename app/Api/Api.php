	...
	public function discover()
	{
        ...
        $collection = \Cache::remember($key, days(1), function() {
            return collect([
                ...
                $this->order(7)->ranking('rcm', 'Equivalent to the RCM levels'),
                $this->order(8)->ranking('abrsm', 'Equivalent to the ABRSM levels'),
                $this->order(9)->ranking('suzuki', 'Equivalent to the Suzuki series'),
            ]);
        });
