...
trait Questions
{
	...
	protected $questions = [
		...
		'Which option best describes where you are right now in your piano journey?' => [
			...
			['label' => 'I don\'t like playing in front of people', 'subtitle' => 'I enjoy playing by myself', 'keywords' => ['type' => 'level', 'term' => 'late intermediate']],
			['label' => 'I am a professional pianist', 'subtitle' => 'I can play most repertoire', 'keywords' => ['type' => 'level', 'term' => 'advanced']]
		],
	];
}
